...
<ul class='nav nav-tabs' id='myTab' role='tablist'>
  <li class='nav-item'>
    <a class='nav-link active' id='home-tab' data-toggle='tab' href='#home' role='tab' aria-controls='home' aria-selected='true'>Canton 1</a>
  </li>
  <li class='nav-item'>
    <a class='nav-link' id='sjo-tab' data-toggle='tab' href='#sjo' role='tab' aria-controls='sjo' aria-selected='false'>Canton 2</a>
  </li>
  <li class='nav-item'>
    <a class='nav-link' id='ala-tab' data-toggle='tab' href='#ala' role='tab' aria-controls='ala' aria-selected='false'>Canton 3</a>
  </li>
  <li class='nav-item'>
    <a class='nav-link' id='her-tab' data-toggle='tab' href='#her' role='tab' aria-controls='her' aria-selected='false'>Canton 4</a>
  </li>
  <li class='nav-item'>
    <a class='nav-link' id='car-tab' data-toggle='tab' href='#car' role='tab' aria-controls='car' aria-selected='false'>Canton 5</a>
  </li>
</ul>
